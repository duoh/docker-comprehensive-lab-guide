...
>
>There are a few more instructions that can be used in Dockerfile, please refer to [Dockerfile reference](https://docs.docker.com/engine/reference/builder/).
...
CMD ["node", "index.js"]
```
> The Dockerfile has two stages; this is referred to as a "multistage" Dockerfile.
> 
> Each stage starts from a base image, and then supplies commands to run on top of that base image.
> 
